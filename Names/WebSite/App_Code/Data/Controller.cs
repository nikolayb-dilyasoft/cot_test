...
namespace TestCompany.Data
{
	public partial class DataControllerBase
    {
        ...
        public static string CreateReportInstance(Type t, string name, string controller, string view, bool validate)
        {
            ...
            Stream res = t.Assembly.GetManifestResourceStream(String.Format("TestCompany.Reports.{0}", name));
            if (res == null)
            	res = t.Assembly.GetManifestResourceStream(String.Format("TestCompany.{0}", name));
            if (res == null)
            {
            ...
            if (isGeneric)
            {
                ...
                ControllerConfiguration config = TestCompany.Data.Controller.CreateConfigurationInstance(t, controller);
