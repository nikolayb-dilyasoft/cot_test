...
namespace TestCompany.Data
{
    ...
    public class Localizer
    {
        ...
        public static Stream CreateDictionaryStream(string culture, string baseName, string objectName, out string[] files)
        {
            ...
            Stream result = t.Assembly.GetManifestResourceStream(CultureManager.ResolveEmbeddedResourceName(String.Format("TestCompany.{0}{1}", baseName, fileName), culture));
            if (result == null)
        ...
        public static LocalizationDictionary CreateDictionary(string baseName, string objectName)
        {
            ...
            string fileName = String.Format("TestCompany.{0}.{1}.txt", objectName, culture);
