...
namespace TestCompany.Handlers
{
    ...
    public class SiteBase : TestCompany.Web.PageBase
    {
        ...
        public static string Copyright
        {
            get
            {
                return "&copy; 2017 TestCompany. ^Copyright^All rights reserved.^Copyright^";
            }
        }
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            string themePath = Server.MapPath("~/App_Themes/TestCompany");
            if (Directory.Exists(themePath))
            	foreach (string stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!(fileName.Equals("_Theme_Aquarium.css")))
                    {
                        ...
                        link.Href = ("~/App_Themes/TestCompany/" + fileName);
