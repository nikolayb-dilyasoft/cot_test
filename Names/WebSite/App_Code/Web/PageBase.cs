...
namespace TestCompany.Web
{
    ...
    public class PageBaseCore : System.Web.UI.Page
    {
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            tempWriter.Flush();
            tempWriter.Close();
            string page = TestCompany.Data.Localizer.Replace("Pages", Path.GetFileName(Request.PhysicalPath), sb.ToString());
            if (page.Contains("data-content-framework=\"bootstrap\""))
            	if (ApplicationServices.EnableCombinedCss)
                	...
                	page = Regex.Replace(page, "\\/>\\s*<title>", (("/><link href=\"" + ResolveClientUrl("~/css/sys/bootstrap.css")) 
